...
public class FrontCodedString2IntBidiMapBuilder
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        ShiftAddXorSignedStringMap dict = new ShiftAddXorSignedStringMap(
                stringList.iterator(),
                new X(stringList, TransformationStrategies.prefixFreeUtf16()));
...
class X extends TwoStepsLcpMonotoneMinimalPerfectHashFunction {
    protected X(Iterable keys, TransformationStrategy transform) throws IOException {
        super(keys, 0, transform, 0, null);
    }
}
